    ...
    <el-container>
      ...
      <el-main>
        <el-row class="main-nav" style="height: 100px;line-height: 100px;background-color: slategray;color: white;">
          ...
          <el-col :xs="3" :sm="3" :md="3" :lg="3" :xl="3">
            <router-link :to="{path:'/MonPointPage'}">
              {{monPoint}}
            </router-link>
          </el-col>
          <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
          ...
          <el-col :xs="3" :sm="3" :md="3" :lg="3" :xl="3">
            <router-link :to="{path:'/HistoricalData'}" style="text-decoration: none;color: white">
              {{historicalData}}
            </router-link>
          </el-col>
          <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
          ...
          <el-col :xs="3" :sm="3" :md="3" :lg="3" :xl="3">
            <router-link :to="{path:'/semanticSearchPage'}" style="text-decoration: none;color: white">
              {{semanticSearch}}
            </router-link>
          </el-col>
        </el-row>
      ...
      <el-main>
        <span style="float: left;padding: 20px;">当前位置：{{monPoint}}</span>
      </el-main>
      <el-container>
